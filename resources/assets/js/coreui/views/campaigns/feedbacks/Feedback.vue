                    ...
                    <b-card id="feedback">
                        ...
                        <b-table
                            ...
                            <template slot="fromInfluencer" slot-scope="data">
                                From influencer:
                                <router-link :id="id = data.item.id" :name="data.item.name = data.item.fromInfluencer" :data="influencer = data.item" :to="{ name: 'InfluencerBonuses', params: { influencer: influencer, id: id, campaign_name: campaign_name } }">{{ data.item.fromInfluencer }}</router-link>
                            </template>
                            <template
                                    slot="status"
                                    slot-scope="data">
